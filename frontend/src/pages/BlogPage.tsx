...
const BlogPage: React.FC = () => {
  ...
  const fallbackPosts = [
    {
      ...
      excerpt:
        'My journey transitioning from the music industry to cloud computing and the transferable skills that made it possible.',
      date: '2024-03-15',
      readTime: '5 min read',
    ...
    },
    {
      ...
      excerpt:
        'Exploring the power of TanStack Router, Query, and Form for building performant React applications.',
      date: '2024-02-28',
      readTime: '8 min read',
    ...
    },
    {
      ...
      excerpt:
        'Lessons learned from deploying cloud infrastructure using AWS CDK in production environments.',
      date: '2024-02-10',
  ...
  const blogPosts = error || !wpBlogPosts ? fallbackPosts : wpBlogPosts.map(transformWpBlogPost)
        ...
        <div className='hero bg-base-200 rounded-lg mb-12'>
          <div className='hero-content text-center'>
            <div className='max-w-md'>
              ...
              <p className='py-4'>
                Insights from my journey across multiple industries, technical tutorials, and
                thoughts on modern software development practices.
              </p>
            </div>
          </div>
        </div>
