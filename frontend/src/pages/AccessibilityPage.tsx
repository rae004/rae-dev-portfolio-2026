        ...
        <div className='card bg-base-100 shadow-xl mb-8'>
          <div className='card-body'>
            ...
            <div className='mt-6 p-4 bg-base-200 rounded-lg'>
              <p className='text-sm'>
                <strong>Response Time:</strong> We aim to respond to accessibility feedback within 2
                business days and will work to address any issues as quickly as possible.
              </p>
            </div>
          </div>
        </div>
