...
const ResumePage: React.FC = () => {
  const { data: resumeItems, isLoading, error } = useResumeItems({
    status: 'publish',
    orderby: 'date',
    order: 'desc',
  })
          ...
          <div className="card-body">
            ...
            {resumeItems && resumeItems.length > 0 ? (
              <div className="space-y-6">
                {resumeItems.map((item) => (
                  <div key={item.id}>
                    ...
                    <p className="text-base-content/70">{item.type} • {new Date(item.date).toLocaleDateString()}</p>
                    <div 
              ...
              <div className="text-center py-8">
                <p className="text-base-content/70">No resume items found. Please add some content in WordPress.</p>
              </div>
            ) : null}
            ...
            {error && (
              <div className="space-y-6 opacity-60">
                <div>
                  ...
                  <p className="mt-2">
                    Certified cloud engineer deploying workloads to AWS using Infrastructure as Code (IaC) 
                    and CI/CD best practices with TypeScript and Python.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2">
                    Developed e-commerce solutions using Magento, Shopify, and WordPress, 
                    building custom features and integrations.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-2">
                    Recorded and mixed albums and singles for artists and labels, 
                    managed world-class recording studios.
                  </p>
                </div>
              </div>
            )}
